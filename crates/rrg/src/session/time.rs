...
// TODO: What is this function doing here? This module has nothing in common
// with the `session` module.
...
pub fn time_from_micros(
    micros: u64,
) -> Result<std::time::SystemTime, TimeMicrosConversionError> {
